CREATE DATABASE  IF NOT EXISTS `zhuxin-dev` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `zhuxin-dev`;
-- MySQL dump 10.13  Distrib 5.7.17, for macos10.12 (x86_64)
--
-- Host: localhost    Database: zhuxin-dev
-- ------------------------------------------------------
...
--
-- Dumping events for database 'zhuxin-dev'
--

--
-- Dumping routines for database 'zhuxin-dev'
--
...
-- Dump completed on 2020-03-03 14:37:09
